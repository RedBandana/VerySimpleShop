...
export const CONTACT_EMAIL = process.env.MAIL_FROM;
export const WEBSITE_LINK = process.env.FRONTEND_URL;
export const WEBSITE_LINK_PROD = process.env.FRONTEND_URL_PROD;
export const MAX_FILES_AMOUNT = 10;
export const DEFAULT_DOCUMENT_URL =
  'https://res.cloudinary.com/dis2drnqz/image/upload/v1739115026/documents/templates/BC-fiche-assiduite.pdf';
