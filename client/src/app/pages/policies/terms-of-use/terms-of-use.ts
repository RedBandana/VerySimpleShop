...
@Component({
  ...
  styleUrls: ['./terms-of-use.scss', '../../page.scss']
})
export class TermsOfUse {
  termsOfUseEn: string = `
  ## ACCEPTANCE OF TERMS
  Welcome to Sorano (“we,” “our,” or “us”). By accessing or using our website and services, you accept and agree to be bound by these Terms, our Privacy Policy, and any other legal notices or guidelines posted on the Site. If you do not agree with any part of these Terms, you must not use our services.

  ## DESCRIPTION OF SERVICE
  Sorano provides tools and resources for individuals looking to form companies in Canada, including but not limited to company registration, compliance assistance, and business consultation.
  ...
  All content provided on the Site (e.g., text, graphics, logos, images, software) is the property of Sorano or its licensors and is protected by applicable intellectual property laws. You may not copy, modify, distribute, or sell any content without our prior written consent.
  ...
  To the maximum extent permitted by law, Sorano shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, arising out of or in connection with your use or inability to use the Service.

  ## INDEMNIFICATION
  You agree to indemnify and hold Sorano harmless from any claims, losses, damages, liabilities, including legal fees, arising out of your use or misuse of the Service, violation of these Terms, or violation of any rights of a third party.
  ...
  Sorano reserves the right to modify or supplement this Policy, with users notified of any changes. Users have the option to terminate their contract if they do not agree with policy changes.

  For any inquiries regarding this Policy or the handling of personal information, please contact us at contact@soranolabs.com.
  `;

  termsOfUseFr: string = `
  ## ACCEPTATION DES CONDITIONS
  Bienvenue sur le site de Sorano (« nous », « notre » ou « nos »). En accédant à notre site web et à nos services ou en les utilisant, vous acceptez d'être lié par les présentes Conditions, par notre Politique de confidentialité et par tout autre avis juridique ou directive publié sur le Site. Si vous n'êtes pas d'accord avec une partie de ces conditions, vous ne devez pas utiliser nos services.

  ## DESCRIPTION DU SERVICE
  Sorano fournit des outils et des ressources aux personnes qui cherchent à créer des entreprises au Canada, y compris, mais sans s'y limiter, l'enregistrement d'une entreprise, l'aide à la conformité et la consultation commerciale.
  ...
  Dans les limites autorisées par la loi, Sorano ne sera pas responsable des dommages indirects, accessoires, spéciaux, consécutifs ou punitifs, ou de toute perte de profits ou de revenus, découlant de ou en rapport avec votre utilisation ou votre incapacité à utiliser le Service.

  ## INDEMNISATION
  Vous acceptez d'indemniser et de dégager Sorano de toute responsabilité en cas de réclamations, pertes, dommages, responsabilités, y compris les frais de justice, résultant de votre utilisation ou mauvaise utilisation du Service, de la violation des présentes Conditions, ou de la violation de tout droit d'un tiers.
  ...
  Sorano se réserve le droit de modifier ou de compléter cette Politique, les utilisateurs étant informés de tout changement. Les utilisateurs ont la possibilité de résilier leur contrat s'ils ne sont pas d'accord avec les modifications de la politique.
  
  Pour toute question concernant cette Politique ou le traitement des informations personnelles, veuillez nous contacter à contact@soranolabs.com.
  `;
